...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav
        className={[
          "fixed top-0 z-50 w-full flex flex-wrap items-center justify-between px-5 md:px-2 py-3 navbar-expand-lg transition duration-500",
          colorChange
            ? "c-bg-trueGray-700"
            : bgColor,
        ].join(" ")}
      >
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start md:px-8">
            <Link href="/">
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              >
                ...
                <ul
                  className={[
                    "relative left-8 lg:left-0 lg:absolute lg:top-16",
                    colorChange
                      ? "c-bg-trueGray-700"
                      : bgColor,
                    servicesDropDownStatus
              ...
              >
                <Link
                  href="https://delightful-dune-0cb557103.azurestaticapps.net/"
                  className="flex items-center"
                >
                  <div
                    className={[
