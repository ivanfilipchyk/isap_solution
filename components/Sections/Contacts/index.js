    ...
    <section className="relative block md:pt-16 lg:pt-0 mt-0 lg:mt-20 overflow-hidden">
      <div className="container-none mx-auto">
        <div className="flex flex-wrap bg-trueGray-200">
          <div className="w-full width-40 padding-box-x box-twoColumn-left c-bg-trueGray-700 md:pl-20 md:pr-12 lg:mb-0">
          ...
          <div className="w-full width-60 padding-box-x box-twoColumn-right relative">
