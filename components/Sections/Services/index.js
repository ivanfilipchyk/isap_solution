      ...
      <div className="padding-box-x box-twoColumn-left box-twoColumn-right">
        ...
        <div className="flex flex-wrap mt-12 mx--16px">
          <Link href="services/sap">
            <div className="w-full md:w-1/2 lg:w-1/3 md:pt-0 md:px-2 lg:px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-trueGray-200 w-full transform-scale">
                <img
                  alt="SAP"
                ...
                <div className="px-4 py-5-mini flex-auto">
                  ...
                  <p className="mt-2 mb-4 text-trueGray-400 text-sm text-left h-16">
                    Our expert
                    consulting services
                    are tailored to the
                    legal,
          ...
          <Link href="services/java_development">
            <div className="w-full md:w-1/2 lg:w-1/3 pt-4 md:px-2 lg:px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-trueGray-200 w-full transform-scale">
                <img
          ...
          <Link href="services/web_development">
            <div className="w-full md:w-1/2 lg:w-1/3 pt-4 md:pt-0 lg:pt-8 md:px-2 lg:px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-trueGray-200 w-full top_4_pc transform-scale">
                <img
                  alt="WEB & Marketplace
                      Development"
          ...
          <Link href="services/projectmanagement">
            <div className="w-full md:w-1/2 lg:w-1/3 pt-4 md:pt-4 lg:pt-0 md:px-2 lg:px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-trueGray-200 w-full transform-scale">
                <img
          ...
          <Link href="services/itoutsource">
            <div className="w-full md:w-1/2 lg:w-1/3 pt-4 md:pt-0 lg:pt-4 md:px-2 lg:px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-trueGray-200 w-full transform-scale">
                <img
          ...
          <Link href="services/host">
            <div className="w-full md:w-1/2 lg:w-1/3 pt-4 md:pt-4 lg:pt-8 md:px-2 lg:px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-trueGray-200 w-full transform-scale">
                <img
                  alt="Hosting & Cloud"
