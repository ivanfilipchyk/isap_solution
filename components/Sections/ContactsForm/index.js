...
export default function ContactsForm (props) {
  return (
    <div className="flex flex-col min-w-0 break-words w-full bg-trueGray-200 relative bottom-0">
      <div className="flex-auto flex flex-wrap p-4 lg:pl-10 lg:pr-20 .justify-between">
        ...
        <div className="relative w-full md:w-1/49 mb-3 px-0 md:px-2">
          <input
            type="text"
            className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-trueGray-200 text-sm border-b border-gray-400 focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
        ...
        <div className="relative w-full mb-3 px-0 md:px-2">
          <textarea
            rows="1"
            cols="80"
            className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-trueGray-200 text-sm border-b border-gray-400 focus:outline-none focus:ring w-full"
            placeholder="Message"
          />
        </div>
