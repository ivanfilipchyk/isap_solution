    ...
    <section className="bg-gray-100 team-pb-80px">
      ...
      <div className="padding-box-x team-container bg-gray-100">
        <div className="flex flex-wrap">
          <div className="flex w-full box-twoColumn-left width-40 mb-20px flex flex-wrap relative c-bg-trueGray-200">
            <img
              className="w-full md:w-1/2 h-300px object-cover align-middle relative top-0"
              src="/img/ceo_tin.png"
              alt="ceo"
            />
            <div className="w-full md:w-1/2 lg:absolute right-0 p-5">
          ...
          <div className="w-full box-twoColumn-right width-60 ml-container-card mb-20px md\:my-5 lg:mt-0 flex flex-wrap lg:flex-nowrap">
