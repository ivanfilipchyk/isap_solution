...
export default function FooterIndustries() {
  return (
    <>
      <div className="footer-container mt--140px">
          ...
          <div className="form-footer-box flex flex-col min-w-0 break-words w-full relative bottom-0 form-footer-color">
            <div className="flex-auto flex flex-wrap p-40px">
              ...
              <div className="relative w-full md:w-1/2 mb-3 px-0 md:px-2">
                <input
                  type="text"
                  className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 form-footer-color text-sm border-b border-gray-400 focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
              ...
              <div className="relative w-full mb-3 px-0 md:px-2">
                <textarea
                  rows="1"
                  cols="80"
                  className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 form-footer-color text-sm border-b border-gray-400 focus:outline-none focus:ring w-full"
                  placeholder="Message"
                />
              </div>
